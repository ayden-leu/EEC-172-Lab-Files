...
// Clock signal (CS)  (PIN_15)
#define OLED_CS_BASE     GPIOA2_BASE
#define OLED_CS_BIT     0x40

// Data Command (DC)  (PIN_18)
#define OLED_DC_BASE     GPIOA3_BASE
#define OLED_DC_BIT     0x10

// RESET (PIN_45)
#define OLED_RESET_BASE  GPIOA3_BASE
#define OLED_RESET_BIT  0x80
...
*/
    ...
    // Set CS low
    GPIOPinWrite(OLED_CS_BASE, OLED_CS_BIT, 0x00);

    // Set DC to low (command mode)
    GPIOPinWrite(OLED_DC_BASE, OLED_DC_BIT, 0x00);

    // Send command byte
    MAP_SPIDataPut(GSPI_BASE, c);

    // Clear RX register
    MAP_SPIDataGet(GSPI_BASE, &emptyVal);

    // Disable SPI CS and set high
    MAP_SPICSDisable(GSPI_BASE);
    GPIOPinWrite(OLED_CS_BASE, OLED_CS_BIT, OLED_CS_BIT);
}
//*****************************************************************************
...
*/
    ...
    // Set DC to high (data mode)
    GPIOPinWrite(OLED_DC_BASE, OLED_DC_BIT, OLED_DC_BIT);
...
//    GPIOPinWrite(GPIOA2_BASE, 0x40, 0x00);
    GPIOPinWrite(OLED_RESET_BASE, OLED_RESET_BIT, 0x00);
    ...
    // Set RESET to high
    GPIOPinWrite(OLED_RESET_BASE, OLED_RESET_BIT, OLED_RESET_BIT);
